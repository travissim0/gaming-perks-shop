...
FROM auth.users 
WHERE email = 'nolanpower@gmail.com';
...
WHERE customer_email = 'nolanpower@gmail.com';

-- Success message
SELECT 'User deletion complete. They can now re-register with nolanpower@gmail.com' as status; 